#' tsutils: Functions for time series exploration, modelling and forecasting.
#'
#' The tsutils package provides functions to support various aspects of time series and forecasting modelling.
#'
